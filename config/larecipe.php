...
return [
    ...
    */
    ...
    'search'            => [
        ...
        'engines'       => [
            ...
            'algolia'   => [
                'key'   => '01b739117b5d45d29358cfba9f684e02',
                'index' => 'larecipe'
            ]
        ]
    ],
    ...
    */
    ...
    'ui'                 => [
        ...
        'fav'            => '/images/logo.png',     // eg: fav.png
    ...
    */
    ...
    'seo'                 => [
        ...
        'description'     => 'Write gorgeous documentations for your products using Markdown inside your Laravel app.',
        'keywords'        => 'Laravel, Larecipe, docs, api docs, documentation',
        'og'              => [
            'title'       => 'LaRecipe - Beautiful Documentations',
            'type'        => 'article',
            'url'         => 'https://larecipe.saleem.dev/',
            'image'       => 'https://larecipe.saleem.dev/images/screenshot.png',
            'description' => 'Write gorgeous documentations for your products using Markdown inside your Laravel app.',
        ]
    ],
